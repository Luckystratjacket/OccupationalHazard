    ...
    switch (action) {
        case 'ent':
            newState = Object.assign(newState, {
                ...
                background: [{ url: './img/copierRoom.png', width: '100%', height: '100%' }],
            });
            break;
        case 'inv':
            newState = Object.assign(newState, {
        ...
        case 'inv3':
            newState = Object.assign(newState, {
                dialog: 'The paper seems to be some sort of checking account balance. Seems a check written by Dave never got cashed. And it looks like it was made out to someone with a first name starting with J...',
                choices: ['Investigate the Copier room more', 'Exit out into the hallway'],
                actions: ['copierroom.inv4', 'hallway.ent3'],
                background: [{ url: './img/check.png', width: '100%', height: '100%' }],
            });
            break;
        case 'inv4':
            newState = Object.assign(newState, {
        ...
        case 'inv6':
            if (newState.items.indexOf('key') == -1) {
                newState = Object.assign(newState, {
                    ...
                    background: [{ url: './img/key.png', width: '100%', height: '100%' }],
                });
            } else {
                newState = Object.assign(newState, {
