    ...
    switch (action) {
        case 'ent':  
               newState = Object.assign(newState, {
                ...
                background: [{ url: './img/steveOffice.png', width: '100%', height: '100%' }],
            });
            break;
            case 'inv':  
               newState = Object.assign(newState, {
                dialog: 'You look around Steve\'s office. After looking around, you discover a large blackboard covered with pictures and arrows. From what you can tell from the crude diagrams, it seems to suggest that Dave was bribing John. What it was about, he seems to have no clue.',
