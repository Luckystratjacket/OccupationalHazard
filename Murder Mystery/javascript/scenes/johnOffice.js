    ...
    switch (action) {
        case 'ent':
            newState = Object.assign(newState, {
                ...
                background: [{ url: './img/johnOfficeNew.png', width: '100%', height: '100%' }],
            });
            break;
        case 'dia':
            newState = Object.assign(newState, {
                ...
                background: [{ url: './img/johnOffice_ALEXANDRIA_NORMAL.png', width: '100%', height: '100%' }],
            });
            break;
        case 'dia2':
            newState = Object.assign(newState, {
        ...
        case 'dia3':
            newState = Object.assign(newState, {
                ...
                background: [{ url: './img/johnOffice_ALEXANDRIA_ANGRY.png', width: '100%', height: '100%' }],
            });
            break;
        case 'dia4':
            newState = Object.assign(newState, {
