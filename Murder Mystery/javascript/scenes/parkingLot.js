    ...
    switch (action) {
        ...
        case 'RIL2':
            newState = Object.assign(newState, {
                ...
                background: [{ url: './img/parkingLot1.png', width: '100%', height: '100%' }],
            });
    ...
    switch (action) {
        case 'RIL4':
            newState = Object.assign(newState, {
                ...
                background: [{ url: './img/parkingLot2.png', width: '100%', height: '100%' }],
            });
    ...
    switch (action) {
        case 'RIL6':
            newState = Object.assign(newState, {
                ...
                background: [{ url: './img/parkingLot3.png', width: '100%', height: '100%' }],
            });
    ...
    switch (action) {
        case 'RIL8':
            newState = Object.assign(newState, {
                ...
                background: [{ url: './img/parkingLot4.png', width: '100%', height: '100%' }],
            });
    ...
    switch (action) {
        case 'RIL9':
            newState = Object.assign(newState, {
                ...
                background: [{ url: './img/parkingLot5.png', width: '100%', height: '100%' }],
            });
